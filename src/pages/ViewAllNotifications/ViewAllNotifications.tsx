...
const ViewAllNotifications: React.FC = () => {
  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      title: 'Budget Alert',
      message:
        "You've spent 85% of your monthly food budget. Consider reducing dining out expenses.",
    ...
    },
    {
      ...
      message:
        'New transaction detected: Online Shopping at Amazon for electronics.',
    ...
    },
    {
      ...
      title: 'Savings Goal',
      message:
        "Congratulations! You've reached 75% of your monthly savings goal. Keep it up!",
    ...
    },
    {
      ...
      message:
        'Multiple transactions detected in Entertainment category. Review your spending.',
  ...
  return (
    ...
    >
      <motion.div
        className="view-all-notifications__header"
      ...
      <motion.div
        className="view-all-notifications__filters"
        variants={itemVariants}
      >
      ...
      <motion.div
        className="view-all-notifications__content"
        variants={itemVariants}
      >
            ...
            {filteredNotifications.map(notification => (
              ...
              >
                ...
                <div className="notification-card__footer">
                  <span
                    className={`notification-card__type notification-card__type--${notification.type}`}
                  >

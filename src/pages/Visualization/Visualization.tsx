    ...
    >
        ...
        <motion.div className="chart-container chart-container--large" variants={itemVariants}>
          ...
          <div className="chart-content">
            ...
            <div className="chart-legend">
              ...
              <div className="legend-item">
                <div className="legend-color" style={{ backgroundColor: 'var(--primary-blue)' }} />
                <span>Spending</span>
              </div>
            </div>
          </div>
          ...
          <div className="chart-content">
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={monthlyComparisonData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                ...
                />
                <Bar dataKey="budget" fill="var(--gray-300)" name="Budget" radius={[2, 2, 0, 0]} />
                <Bar dataKey="lastMonth" fill="var(--gray-400)" name="Last Month" radius={[2, 2, 0, 0]} />
                <Bar dataKey="thisMonth" fill="var(--primary-blue)" name="This Month" radius={[2, 2, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </motion.div>
            ...
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={dailySpendingData}>
                ...
                <Line 
                  ...
                  strokeWidth={3}
                  dot={{ fill: 'var(--secondary-orange)', strokeWidth: 2, r: 4 }}
                  activeDot={{ r: 6, stroke: 'var(--secondary-orange)', strokeWidth: 2 }}
                />
              </LineChart>
            </ResponsiveContainer>
          </div>
      ...
      <motion.div className="visualization__summary" variants={itemVariants}>
        <div className="summary-card">
          ...
          <span className="summary-change summary-change--negative">+12% vs last month</span>
        </div>
        
        <div className="summary-card">
          <h4>Highest Spending Day</h4>
          <span className="summary-value">$300</span>
          <span className="summary-change summary-change--neutral">January 7th</span>
        </div>
        
        <div className="summary-card">
          <h4>Most Frequent Category</h4>
          <span className="summary-value">Food & Dining</span>
          <span className="summary-change summary-change--neutral">35% of transactions</span>
        </div>
        
        <div className="summary-card">
          <h4>Budget Performance</h4>
          <span className="summary-value">85%</span>
          <span className="summary-change summary-change--positive">Within budget</span>
        </div>
      </motion.div>
    </motion.div>
  )

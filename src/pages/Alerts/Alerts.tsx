  ...
  const [alerts, setAlerts] = useState<Alert[]>([
    {
      ...
      message: 'You have exceeded your Food & Dining budget by $200 this month.',
            ...
            {alertRules.map((rule) => (
              <div key={rule.id} className="rule-item">
                ...
                <div className="rule-item__actions">
                  ...
                  <button className="control-btn control-btn--danger" aria-label="Delete rule">
                    <X size={16} />
                  </button>
                </div>
              </div>
            ...
            >
              ...
              <form className="form-content">
                <div className="form-group">
                  ...
                  <input type="text" className="form-input" placeholder="Enter rule name" />
                </div>
                ...
                <div className="form-actions">
                  <button type="button" className="btn btn--secondary" onClick={() => setShowNewRuleForm(false)}>
                    Cancel
                  </button>
